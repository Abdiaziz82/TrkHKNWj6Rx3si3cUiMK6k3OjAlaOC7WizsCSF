...
const Profile = () => {
  ...
  const customerMetrics = [
    { label: "Loyalty Points", value: "1,250", color: "text-green-600" },
    { label: "Total Orders", value: "28", color: "text-blue-600" },
    { label: "Member Since", value: "2023", color: "text-gray-600" }
  ];

  const orderStats = [
    { label: "Pending Orders", value: "3", trend: "+1" },
    { label: "Completed Orders", value: "25", trend: "+5" },
    { label: "Total Spent", value: "₦285K", trend: "+12%" }
  ];

  const quickActions = [
    { icon: ShoppingBag, label: "My Orders", description: "View order history", action: "orders" },
    { icon: Package, label: "Track Package", description: "Monitor deliveries", action: "tracking" },
    { icon: CreditCard, label: "Payment Methods", description: "Manage payments", action: "payments" },
    { icon: Bell, label: "Notifications", description: "Alert preferences", action: "notifications" }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage your account and shopping preferences</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl p-6 text-white shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center pb-3 border-b border-blue-500/30">
                  <span className="text-blue-100">Last Order</span>
                  <span className="font-semibold">3 days ago</span>
                </div>
                <div className="flex justify-between items-center pb-3 border-b border-blue-500/30">
                  <span className="text-blue-100">Loyalty Tier</span>
